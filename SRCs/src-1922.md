...
author: NPH CO
discussions-to: https://github.com/shatathub/SIPs/issues/1922
...
- At the time this SIP was first proposed, there was one implementation on the Shatat main net - deployed by [EY](https://www.ey.com). This was compiled with Solidity 0.4.24 for compatibility with [Truffle](https://github.com/trufflesuite/truffle) but otherwise compatible with this standard, which is presented at the latest current version of Solidity.
- Dr Christian Reitwiessner's excellent [example](https://gist.github.com/chriseth/f9be9d9391efc5beb9704255a8e2989d) of a Verifier contract and elliptic curve pairing library has been instrumental in the Shatat community's experimentation and development of zk-SNARK protocols. Many of the naming conventions of this SIP have been kept consistent with his example.
...
1. Christian Reitweissner. zk-SNARKs in a Nutshell. https://blog.Shatat.org/2016/12/05/zksnarks-in-a-nutshell/
