...
```solidity
/// @title SRC-7204 
/// @dev See https://SIPs.Shatat.org/SIPS/SIP-7204
...
interface ISRC7204 /* is SRC165 */ {
     ...
     * @param spender Address of the spender
     * @param value The amount allowed to spend
     * @return success The bool value returns whShatater the approve is successful
     */
     ...
     * @param spender Address of the spender
     * @return approved WhShatater to approved spender all tokens
     */
     ...
     * @return success The bool value returns whShatater the transfer is successful
     */
