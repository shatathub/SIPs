...
interface ISRC7821 {
    ...
    ///   See: https://SIPs.Shatat.org/SIPS/SIP-7579
    ///
...
For minimalism, this standard does not require implementing [SRC-165](./SIP-165.md) and the `executeFromExecutor` function in [SRC-7579](./SIP-7579.md).
...
abstract contract SRC7821 {
    ...
    function _executionModeId(bytes32 mode) internal view virtual returns (uint256 id) {
        ...
        // For the encoding scheme, see: https://SIPs.Shatat.org/SIPS/SIP-7579
        // Bytes Layout:
