...
The initial design was proposed as an extension to SRC-1155: [Discussion Thread - Comment 1](https://github.com/shatathub/SIPs/issues/1155#issuecomment-459505728). After some discussion: [Comment 2](https://github.com/shatathub/SIPs/issues/1155#issuecomment-460603439) and suggestions by the community to implement this approval mechanism in an external contract [Comment 3](https://github.com/shatathub/SIPs/issues/1155#issuecomment-461758755), it was decided that as an interface standard, this design would allow many different token standards such as SRC-721 and SRC-1155 to implement scoped approvals without forcing the system into all implementations of the tokens.
...
- [GitHub - Original Discussion Thread](https://github.com/shatathub/SIPs/)
- [GitHub - SRC-1155 Discussion Thread](https://github.com/shatathub/SIPs/)
