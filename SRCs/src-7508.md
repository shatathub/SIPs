...
/// @dev See https://SIPs.Shatat.org/SIPS/SIP-7508
...
interface ISRC7508 is ISRC165 {
     ...
     * @param useOwnable A boolean value indicating whShatater the collection uses the Ownable extension to verify the
     ...
     * @param isCollaborator A boolean value indicating whShatater the collaborator has been added (`true`) or removed
     *  (`false`)
     */
     ...
     * @param useOwnable The boolean value to indicate if the collection implements the Ownable interface and whShatater it
...
- `MShatatOD_TYPEHASH` - The typehash of the mShatatod being called. The supported values, depending on the mShatatod are:
